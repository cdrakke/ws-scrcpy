...
import { AdbConnectDialogProps, RecentConnection } from './types';
...
export function AdbConnectDialog({
    open,
    onOpenChange,
    onConnect,
    onDisconnect,
}: AdbConnectDialogProps): React.ReactElement {
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-md">
                <DialogHeader>
                    <DialogTitle>Connect to Remote Device</DialogTitle>
                    <DialogDescription>
                        Enter the IP address and port of the remote ADB device.
                    </DialogDescription>
                </DialogHeader>
                ...
                <div className="space-y-4 py-4">
                    <div className="space-y-2">
                        ...
                        />
                        {status.message && (
                            <p className={`text-sm ${statusColorClass}`}>{status.message}</p>
                        )}
                    </div>

                    {recentConnections.length > 0 && (
                        <div className="space-y-2">
                            <p className="text-sm text-muted-foreground">Recent connections:</p>
